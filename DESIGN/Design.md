# **Design: How do we design the GPT?**

 

![组装2](示意图/组装2.png)

**Fig.1: Supramolecular assembly of DNA**
...
![image-20251009030907968](示意图/image-20251009030907968.png)

**Fig.3: G-quadruplex linkage mode** (a) Some possible topologies for simple tetramolecular (on the left-hand side) and bimolecular quadruplexes. Strand polarities are shown by arrows.[1] (b) Some possible topologies for simple unimolecular quadruplexes.[2]

---

 

In our design, two TDN monomers are linked together via G-quadruplex formation under the action of metal cations, using the connecting sequences attached to the monomers(Fig.4).

![1+1](动图\1+1.gif)

**Fig.4: The link mode of two TDN monomers through G-quadruplex under the action of metal cations.**
...
1. Assembly at room temperature: At room temperature, we can mix TDN monomers with the ion solution used for assembly to form the assembled structure. This avoids the damage to the DNA structure and the drugs or enzymes loaded on the assembly material that would be caused by the high temperatures required for other assembly reactions.
2. Controllable opening and closing: G-quadruplexes form and TDN monomers connect to each other under the action of metal cations such as potassium ions. When we add crown ether compounds, monovalent metal cations bind to crown ethers, leading to the disassembly of G-quadruplexes [2–4] (Fig.5). This property allows us to adjust the functions of the assembled nanostructures more conveniently and flexibly.

![四面体1+1拆解动画](动图/四面体1+1拆解动画.gif)

**Fig.5: Controlled assembly of TDN monomers.** TDN monomers form G-quadruplex and are interconnected under the action of metal cations such as potassium ions. When the crown ether compound is added, the monovalent metal cation combines with the crown ether, resulting in the decomposition of G-quadruplex.
...
![2010kim图片](示意图/2010kim图片.jpeg)

**Fig.6: Schematic of the design mechanism**[6] (A)Schematic diagram of structural transformation in spherical assembly.(B)Energy surface analysis of G-quadruplex complexes formed by potassium ions.(C)Energy surface analysis of g-quadruplex complexes formed by lithium ions.
...
**Fig.7:** **four single-stranded DNAs form modified TDN.**
...
![序列配对示意](示意图/序列配对示意.png)

**Fig.8:Among the 4 ssDNAs, there are 3 extended sequences at the 5 'end of 3 ssDNAs.**

---

![组装1](示意图/组装1.png)

 ![膜与球笼组装动画卷曲版](动图/膜与球笼组装动画卷曲版.gif)

**Fig.9.10: The assembly steps of TDN monomers.** Mix TDNs modified with different functions in the required proportion, add the corresponding metal cations, and assemble them to form multifunctional integrated two-dimensional nanomembranes or vesicles.
...
1. Synthesize TDNs via one-step annealing.
2. Perform functional modification of TDNs by allowing the extended strand of the TDN to undergo complementary base pairing with the functional group-loaded DNA strand at room temperature.

![四面体功能化](动图/四面体功能化.gif)

**Fig.11:Functional modification of TDN.** It is achieved by allowing the extended strand of TDN to perform complementary base pairing with the DNA strand loaded with functional groups.

---



3. Select the desired structures and functions, mix TDNs with different functional modifications in the required ratio, add the corresponding metal cations, and assemble to form a multifunctional integrated 2D nanomembrane or vesicle(Fig.9,10).
